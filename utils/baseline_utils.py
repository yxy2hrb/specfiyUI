...
if __name__ == "__main__":
    ...
    file_list= Path("/media/sda5/cyn-workspace/UI-SPEC/baselines/cache/gpt4o_text_augmented_prompting").glob("*.html")
    for file in tqdm(file_list):
        take_screenshot(str(file), file.replace(".html", ".png"), do_it_again=True)
